...
class AddHelpTours extends Migration {
    ...
    public function up() {
    	...
    	$insert = "INSERT IGNORE INTO `help_tour_steps` (`tour_id`, `step`, `title`, `tip`, `orientation`, `interactive`, `css_selector`, `route`, `mkdate`) VALUES
            ...
            ('4c41c9760a3248313236af202275109a', 2, 'Meeting benennen', 'Um ein neues Meeting zu erstellen, geben Sie bitte zunächst einen Namen ein und klicke dann auf die Schaltfläche \"Meeting erstellen\".', 'B', 1, 'INPUT[name=name]', 'plugins.php/meetingplugin', 1406709759),
