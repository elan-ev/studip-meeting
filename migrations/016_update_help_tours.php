...
class UpdateHelpTours extends Migration {
    ...
    public function up() {
        ...
        $insert = "INSERT IGNORE INTO `help_tour_steps` (`tour_id`, `step`, `title`, `tip`, `orientation`, `interactive`, `css_selector`, `route`, `mkdate`) VALUES
            ...
            ('4c41c9760a3248313236af202275109c', 1, 'Meetings anpassen', 'Die Tour zeigt, wie der Name des Werkzeugs verändert und ein Einleitungstext ergänzt werden kann.\r\n\r\nUm zum nächsten Schritt zu gelangen, klicken Sie bitte rechts unten auf \"Weiter\".', 'T', 0, '', 'plugins.php/meetingplugin/index/config', 1406709759),
            ('4c41c9760a3248313236af202275109c', 2, 'Name des Werkzeugs', 'Das Textfeld dient zur Benennung des Reiters. Durch einen Klick auf \"Speichern\" unten wird der Name des Werkzeugs übernommen.', 'BL', 0, '#vc_config_title', 'plugins.php/meetingplugin/index/config', 1406709759),
